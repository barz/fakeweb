...
This is a forked version of _Fakeweb_. The reason to fork was to be able to test POST and PUT requests to a same URI but with different parameters. For example, look at this test:

https://gist.github.com/1189798

In the way to achieve this, 5 tests about precedence get broken (you can check them in <tt>test_precedence.rb</tt>).

So, the precende feature get broken: this feature is about what happen when you redefine the behaviour of an URI more than once.

I'll try to fix this early.
